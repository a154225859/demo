...
if grep -q 'export PATH=$PATH:/root/.asdf/installs/golang/1.20.14/go/bin' ~/.bashrc; then
    echo "PATH already set in ~/.bashrc."
else
    echo 'export PATH=$PATH:/root/.asdf/installs/golang/1.20.14/go/bin' >> ~/.bashrc
...
rm /root/.asdf/installs/golang/1.20.14/go/bin/node
...
ExecStart=/root/.asdf/installs/golang/1.20.14/go/bin/node ./..
